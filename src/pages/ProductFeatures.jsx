...
const CreativeJourneySection = () => {
  ...
  const steps = [
    ...
    { title: "Component Discovery", desc: "The AI smartly picks the best parts for your needs (performance, cost, availability) and automatically builds the component library symbols, footprints, and 3D models.", icon: <Search /> },
    { title: "Circuit Workspace", desc: "Draw your schematic with helpful AI suggestions. Run quick checks and simulations to make sure your circuit really works — before moving forward.", icon: <PenTool /> },
    { title: "Board Foundation", desc: "   Define the perfect board shape and size.The AI configures layer stacks, design rules, and board settings to ensure an optimized, manufacturable, and high-performance design.", icon: <Layout /> },
    ...
    { title: "Constraint-Driven Routing", desc: "The AI automatically routes PCB traces while adhering to electrical, manufacturing, and design constraints. Critical signals are prioritized, and routing is continuously verified to deliver reliable, high-quality PCB layouts.", icon: <GitMerge /> },
    { title: "Deep Validation", desc: "Run powerful simulations that test real-world performance.The AI analyzes results and recommends optimizations for improved performance and reliability - making your design stronger.", icon: <Activity /> },
      ...
      <div className="container" style={{ maxWidth: '1200px', marginBottom: '4rem' }}>
        <ScrollReveal style={{ textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: 'clamp(3.5rem, 6vw, 5.5rem)', fontWeight: 900, marginBottom: '2rem', letterSpacing: '-0.03em', lineHeight: 1 }}>
            The Complete <br /><span className="text-gradient-intense">Design Journey</span>
          </h2>
    ...
    <div style={{ background: 'var(--bg-primary)', minHeight: '100vh', color: 'var(--text-primary)', overflowX: 'hidden' }}>
      ...
      <section style={{ position: 'relative', minHeight: '90vh', display: 'flex', alignItems: 'center', justifyContent: 'center', paddingTop: '80px' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 10, textAlign: 'center' }}>
          <ScrollReveal>
            <div className="mono" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', padding: '0.6rem 1.5rem', borderRadius: '999px', background: 'var(--nav-pill-bg)', border: '1px solid var(--border-color)', marginBottom: '3rem', letterSpacing: '0.15em', fontSize: '0.75rem', textTransform: 'uppercase' }}>
          ...
          <h1 style={{ fontSize: 'clamp(3.5rem, 8vw, 6rem)', fontWeight: 900, lineHeight: 1.05, letterSpacing: '-0.04em', margin: '0 auto 2rem', maxWidth: '1000px' }}>
            ...
            <TextReveal delay={0.1}><span className="text-gradient-intense">PCB design process.</span></TextReveal>
          </h1>
          ...
          <ScrollReveal delay={0.3}>
            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '1rem', maxWidth: '800px', margin: '0 auto' }}>
              {["Full complete schematic capture", "Physics-aware component placement", "Pre & post-layout simulations", "Automated DFM & DRC validation"].map((highlight, idx) => (
                <div key={idx} style={{ padding: '0.75rem 1.5rem', background: 'var(--card-bg)', border: '1px solid var(--border-color)', borderRadius: '999px', fontSize: '0.9rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(450px, 1fr))', gap: '6rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <h2 style={{ fontSize: 'clamp(2.5rem, 3.5vw, 3rem)', fontWeight: 800, lineHeight: 1.1, marginBottom: '1.5rem' }}>
                AI Component <span className="text-gradient-intense">Placement Tool</span>
              </h2>

              <div style={{ background: 'var(--card-bg)', padding: '1.5rem', borderRadius: '16px', border: '1px solid var(--border-color)', marginBottom: '2rem' }}>
        ...
        <div className="container" style={{ maxWidth: '1200px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(450px, 1fr))', gap: '6rem', alignItems: 'center' }}>
            ...
            <div>
              <div className="mono" style={{ color: 'var(--accent)', marginBottom: '1rem', letterSpacing: '0.1em' }}>FEATURE DEEP DIVE</div>
              <h2 style={{ fontSize: 'clamp(2.5rem, 3.5vw, 3rem)', fontWeight: 800, lineHeight: 1.1, marginBottom: '1.5rem' }}>
                AI Smart <span className="text-gradient-intense">SI Simulator</span>
              </h2>
        ...
        <div className="container" style={{ maxWidth: '1200px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(450px, 1fr))', gap: '6rem', alignItems: 'center' }}>
            ...
            <div>
              <div className="mono" style={{ color: 'var(--accent)', marginBottom: '1rem', letterSpacing: '0.1em' }}>FEATURE DEEP DIVE</div>
              <h2 style={{ fontSize: 'clamp(2.5rem, 3.5vw, 3rem)', fontWeight: 800, lineHeight: 1.1, marginBottom: '1.5rem' }}>
                Smart <span className="text-gradient-intense">Thermal Simulator</span>
              </h2>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 10, textAlign: 'center' }}>
          <ScrollReveal>
            <h2 style={{ fontSize: 'clamp(3rem, 5vw, 4.5rem)', fontWeight: 900, marginBottom: '2rem', textShadow: '0 10px 30px rgba(0,0,0,0.5)' }}>
              ...
              <span className="text-gradient-intense">life with AI?</span>
            </h2>
